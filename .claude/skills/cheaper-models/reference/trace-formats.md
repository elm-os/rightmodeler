...
Tool `arguments` and tool schemas often arrive as JSON *strings* — parse defensively.
  ...
  "steps": [
    {
      ...
      "input_messages": [
        {"role": "system|user|assistant|tool", "content": "string|array",
      ...
      "cost_usd": 0.0,
      "success": {"status": "ok|error", "error": null, "accepted": true,
                  "scores": {}, "source_signal": "feedback_stats|scores|is_error|user_accept"},
      "metadata": {},
      "raw": {}
    }
  ]
...
- `success` is heterogeneous across tools — keep the normalized boolean *and* the
