...
export function StarIcon({ size = 14, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 2.5l2.9 5.88 6.49.94-4.7 4.58 1.11 6.46L12 17.82 6.2 20.86l1.11-6.46-4.7-4.58 6.49-.94L12 2.5z" />
    </svg>
  );
}
...
// ── Model / provider marks (Simple Icons, monochrome — inherit currentColor) ──

export function OpenAIIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ClaudeIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GeminiIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MistralIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
