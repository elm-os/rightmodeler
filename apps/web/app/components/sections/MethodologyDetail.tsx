...
function RungRow({ rung, children }: { rung: Rung; children?: ReactNode }) {
  return (
    <div className="grid grid-cols-1 items-baseline gap-x-6 gap-y-2 sm:grid-cols-[1fr_auto]">
      <div>
        <h3 className="text-heading-sm tracking-tighter text-midnight-ink">
          {rung.name}
        </h3>
        <p className="mt-1.5 max-w-[48ch] text-body tracking-tighter text-driftwood">
          {rung.verify}
        </p>
          ...
          <div className="md:sticky md:top-24 md:self-start">
            <Reveal>
              ...
              <h2
                ...
                className="mt-4 font-display text-heading tracking-tighter text-balance text-midnight-ink sm:text-heading-lg"
              >
                We grade the evidence, not just the output.
              </h2>
              <p className="mt-5 max-w-[42ch] text-body tracking-tighter text-driftwood">
