    ...
    <section className="relative isolate overflow-hidden bg-parchment-white">
      ...
      <div className="mx-auto max-w-6xl px-6 py-24 sm:px-8 sm:py-32">
        <div className="max-w-2xl">
          <Reveal>
            <h2 className="font-display text-heading tracking-tighter text-balance text-midnight-ink sm:text-display">
          ...
          <Reveal delay={0.16} className="mt-10">
            <a
              ...
              className="inline-flex w-full gap-2 items-center justify-center gap-2 rounded-lg bg-midnight-ink px-4 py-2 text-[13px] font-medium text-parchment-white transition-transform duration-150 ease-out-strong active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-midnight-ink/40 focus-visible:ring-offset-2 focus-visible:ring-offset-parchment-white sm:w-auto"
            >
              <GitHubIcon size={15} />
              View on GitHub
            </a>
