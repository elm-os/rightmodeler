    ...
    <PageShell>
      ...
      <section className="bg-parchment-white py-16 sm:py-20">
        <Prose>
          ...
          <Lead>
            Browse freely, the pre-release products may change, and every
            figure on this site is an illustrative example. The details
            follow.
          </Lead>

          <H2>Agreement</H2>
          <P>
            By using www.rightmodeler.com (the site), operated by
            rightmodeler, an ELM-OS project (rightmodeler, we, or us), you
          ...
          <P>
            ...
            pre-release: their features, availability, and pricing may change
            or be withdrawn without notice, and joining a waitlist does not
            guarantee access.
          </P>
          ...
          <P>
            ...
            by these terms. Running it is your responsibility: it works
            against your own traces with your own API keys, and you review
            every change it recommends before applying it.
          </P>
          ...
          <P>
            ...
            vulnerabilities outside responsible disclosure, scrape it at
            abusive volume, or use it for anything unlawful.
          </P>

          <H2>Intellectual property</H2>
          <P>
            The site&rsquo;s content, design, and the rightmodeler name and
            wordmark belong to us. Feedback you send may be used to improve
            our products without obligation to you.
          </P>
          ...
          <P>
            ...
            claim relating to the site will not exceed one hundred US dollars.
          </P>

          <H2>Changes</H2>
          <P>
            We may update these terms or change or discontinue the site at any
            time. If the terms change, we will update this page and the date
            at the top; continued use after a change means you accept the
            updated terms.
          </P>
