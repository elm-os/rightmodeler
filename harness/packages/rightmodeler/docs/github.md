...
| GitHub Actions `GITHUB_TOKEN`                                            | Opens pull requests only when the repository allows Actions to create pull requests, and CI on those pull requests waits for approval. Use an App installation token instead. |
